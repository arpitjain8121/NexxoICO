...
(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'dropzone',
        defaults = {
            ...
            text:                   '<div class="uploadPassport">Upload your Passport Copy</div> <br/></br><br/><i class="fa fa-upload fa-4x" style="color:#dddfe7"></i><br/></br><br/><div class="Drag">Drag & Drop</div><br/><div><span style="color:#c5c6c8">your files or</span> <a style="color:#3b86ff;text-decoration:underline" href="#">Browse</a></div>',    //text inside the div
